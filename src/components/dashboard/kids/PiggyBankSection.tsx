    ...
    <div className="space-y-12 animate-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <section className="space-y-6">
        <h3 className="text-2xl font-bold flex items-center gap-3">
          <Star className="text-amber-500" /> Phase 1: The Home Piggy Bank
        </h3>
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 bg-white/5 p-8 rounded-3xl border border-white/10">
            <h4 className="font-bold mb-4 flex items-center gap-2">
              <Zap className="w-5 h-5 text-amber-400" /> Why use a Real Bank?
            </h4>
      ...
      <section className="space-y-6">
        <h3 className="text-2xl font-bold flex items-center gap-3">
          <TrendingUp className="text-emerald-500" /> Phase 3: The Super Piggy Bank (FD)
        </h3>
