    ...
    <div className="space-y-12 animate-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="border-slate-200 shadow-sm overflow-hidden">
          ...
          <CardContent className="pt-6 space-y-4 text-sm text-slate-600 leading-relaxed">
            <p>Ideal for <strong>long-term investors</strong>.</p>
            <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-100 flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-emerald-600 shrink-0 mt-0.5" />
              <p className="text-xs text-emerald-800">Tax benefit: Capital gains at maturity are tax-exempt.</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="bg-red-50 border border-red-100 rounded-3xl p-8 flex flex-col md:flex-row gap-8 items-center">
        ...
        <div className="space-y-2">
          <h4 className="text-xl font-bold text-red-900">Limited Liquidity</h4>
          <p className="text-sm text-red-800 leading-relaxed">
            SGBs have a <strong>lock-in period of 5 years</strong>.
          </p>
        </div>
      </div>
    </div>
